...
export function buildCodexConsultationPrompt(config, context, openAiQuestion) {
  return [
    ...
    "If failureLoop.detected is true, identify the repeated root cause and recommend an unblocked alternative or operator intervention instead of the same failed action.",
    "",
